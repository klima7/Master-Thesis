...
\begin{figure}[ht!]
  \centering
  \fbox{\includegraphics[width=1.0\linewidth]{images/gui_selection_tab.png}}
...
\begin{figure}[ht!]
  \centering
  \fbox{\includegraphics[width=1.0\linewidth]{images/gui_clarification_tab.png}}
...
\begin{figure}[ht!]
  \centering
  \fbox{\includegraphics[width=1.0\linewidth]{images/gui_chat_tab.png}}
