...
\begin{figure}[ht!]
  \centering
  \includesvg[width=1.0\linewidth]{images/duplication_after_translation}
...
\begin{figure}[ht!]
  \centering
  \includesvg[width=1.0\linewidth]{images/query_decomposition_serial}
...
\begin{figure}[ht!]
  \centering
  \includesvg[width=1.0\linewidth]{images/query_decomposition_nested}
...
Pytania podzielone na tokeny powinny znaleźć się w finalnych próbkach pod atrybutem o nazwie \code{question\_toks}. Tokenizacji postanowiono dokonywać z wykorzystaniem dostarczonego w ramach biblioteki \code{SpaCy} wielojęzycznego modelu. Wybrano akurat wariant wielojęzyczny, a nie polski, ponieważ dzięki temu skrypt generujący nie będzie wprowadzał dodatkowych ograniczeń co do języka pytań, a generowanie zbiorów, chociażby z angielskimi pytaniami, również okazało się przydatne. Porównano jednocześnie rezultaty tokenizacji polskich pytań za pomocą modelu wielojęzycznego oraz polskiego. Okazuje się, że wyniki różnią się jedynie w niewielkiej liczbie przypadków, co świadczy o tym, że model wielojęzyczny jest wysokiej jakości.
...
\begin{figure}[ht!]
  \centering
  \includesvg[width=0.9\linewidth]{images/query_tokenization}
...
\centering
\begin{subfigure}{0.49\textwidth}
    \includesvg[width=\textwidth]{images/translation_in_context_table}
    \caption{Dla tabel}
    \label{fig:first}
\end{subfigure}
\hfill
\begin{subfigure}{0.49\textwidth}
    \includesvg[width=\textwidth]{images/translation_in_context_column}
    \caption{Dla kolumn}
    \label{fig:second}
\end{subfigure}
...
\begin{figure}[ht!]
  \centering
  \includesvg[width=1.0\linewidth]{images/value_translation}
...
\begin{figure}[ht!]
  \centering
  \includesvg[width=1.0\linewidth]{images/datasets}
