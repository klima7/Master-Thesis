\section{BRIDGE}
\code{BRIDGE} jest to rozwiązanie, które zostało opublikowane w roku 2020 przez Xi Victoria Lin, Richarda Socher oraz Caiming Xiong \mycite{Lin2020}. Powstało więc nieco ponad rok po \code{RAT-SQL} i w odróżnieniu od niego generuje kompletne zapytania SQL z wartościami, co jest istotną zaletą. Jego kod źródłowy jest umieszczony na platformie Github \mycite{bridge-repository}.
