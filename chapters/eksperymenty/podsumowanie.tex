...
\begin{figure}[H]
  \centering
  \includesvg[width=1.0\linewidth]{images/experiments_em}
  \lcaption{Wyniki metryki \code{EM Without Values} dla wszystkich modeli i zbiorów}{Wartości wyrażono procentowo.}
  \label{fig:experiments-em}
\end{figure}

\begin{figure}[H]
  \centering
  \includesvg[width=1.0\linewidth]{images/experiments_ex}
  \lcaption{Wyniki metryki \code{EX} dla wszystkich modeli i zbiorów}{Dla modelu \code{RAT-SQL} metryki \code{EX} nie da się obliczyć. Wartości wyrażono procentowo.}
